...
int uvSensorPin = A2;
int tiltSensorPin = A1;

int uvDelay = 5;        //In seconds
int gyroDelay = 5;      // In Seconds
int heartRateDelay = 5; // In Seconds

long uvMillis = 0;
long gyroMillis = 0;
long heartRateMillis = 0; // In Seconds
...
{
    if (heartRateMillis == 0)
    {
        heartRateMillis = millis();
    }
    else if (millis() - heartRateMillis > (heartRateDelay * 1000))
    {
        sendHeartRateData();
        heartRateMillis = 0;
    }
...
void sendHeartRateData(){
    ...
    nodeSerial.print("heart:");
    nodeSerial.print(heartRate);
    nodeSerial.println(";");
}
...
void sendActiveTime()
{
    ...
    Serial.print("movement time in seconds");
