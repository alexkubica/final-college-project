		...
		<div className={classes.root}>
			<Router>
				<Switch>
					...
					<Route path="/uv">
						<Title title="Ultraviolet Graph" onReturn={returnHome} onRefresh={fetchUVData} />
						{loading ? (
							<div className={classes.loadingContainer}>
								<CircularProgress />
							</div>
					...
					<Route path="/weather">
						<Title title="Weather Graph" onReturn={returnHome} onRefresh={fetchWeatherData} />
						{loading ? (
							<div className={classes.loadingContainer}>
								<CircularProgress />
							</div>
					...
					<Route path="/heartrate">
						<Title title="Heart Rate Graph" onReturn={returnHome} onRefresh={fetchHeartRateData} />
						{loading ? (
							<div className={classes.loadingContainer}>
								<CircularProgress />
							</div>
					...
					<Route path="/posture">
						<Title title="Posture Graph" onReturn={returnHome} onRefresh={fetchPostureData} />
						{loading ? (
							<div className={classes.loadingContainer}>
								<CircularProgress />
							</div>
					...
					<Route path="/movement">
						<Title title="Movement Graph" onReturn={returnHome} onRefresh={fetchMovementData} />
						{loading ? (
							<div className={classes.loadingContainer}>
								<CircularProgress />
							</div>
					...
					<Route path="/bottle">
						<Title title="Bottle Graph" onReturn={returnHome} onRefresh={fetchBottleData} />
						{loading ? (
							<div className={classes.loadingContainer}>
								<CircularProgress />
							</div>
